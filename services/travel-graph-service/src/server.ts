...
export async function buildServer() {
  ...
  // ── Authentication ─────────────────────────────────────────────
  // All read/search endpoints are public; auth is available for
  // future write operations (create/update/delete graph entities).
  await server.register(createAuthPlugin, {
    ...
    publicPrefixes: [
      ...
      '/api/v1/graph/search',
      '/api/v1/graph/suppliers',
      '/api/v1/graph/map/pins',
      '/api/v1/graph/map/location-score',
