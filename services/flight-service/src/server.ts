...
export async function buildServer() {
  ...
  await server.register(createAuthPlugin, {
    publicRoutes: ['/health', '/ready', '/api/v1/flights/status'],
    publicPrefixes: ['/api/v1/flights/search', '/api/v1/flights/offers', '/api/v1/flights/airports', '/api/v1/flights/airlines', '/api/v1/flights/routes'],
  });
